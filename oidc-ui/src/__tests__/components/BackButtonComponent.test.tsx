...
import BackButtonRenderer from '../../components/BackButtonComponent/BackButtonRenderer';
import type {
...
describe('BackButtonComponent', () => {
  ...
  it('renders the back button element', () => {
    render(<BackButton component={makeComponent()} context={makeContext()} />);
  ...
  it('uses resolveFlowTemplateLiterals when component has a label', () => {
    ...
    render(<BackButton component={component} context={makeContext()} />);
  ...
  it('calls context.onSubmit with the component when clicked', () => {
    ...
    render(<BackButton component={makeComponent()} context={context} />);
  ...
  it('does not throw when clicked and context.onSubmit is undefined (false branch)', () => {
    ...
    const context = makeContext({ onSubmit: undefined as unknown as ComponentRenderContext['onSubmit'] });
    render(<BackButton component={makeComponent()} context={context} />);
...
describe('BackButtonRenderer', () => {
  it('wraps BackButton in a back-button-renderer div', () => {
  ...
  it('passes component and context through to BackButton', () => {
    const context = makeContext();
    const { container } = render(
